...
## Basis
    ...
    ## Grundplatte auf der die Kirche entsteht
    def generate_ground(self):
        bpy.ops.mesh.primitive_cube_add(location=self.church_base_location, scale=(self.basic_plane_width, self.basic_plane_width, self.basic_plane_width * 0.02))
        bpy.context.object.data.materials.append(self.create_material([0.2235, 0.1686, 0.1059, 1.000000]))
